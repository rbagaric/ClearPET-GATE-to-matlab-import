...
options.diameter = 135.6;

%%% Transaxial FOV size (mm), this is the length of the x (horizontal) side
% of the FOV
options.FOVa_x = 70; %94mm maximum transaxial field
...
%%% Axial FOV (mm)
options.axial_fov =  floor(76.8 - options.cr_pz/10); %110mm

%%% Scanner name
% Used for naming purposes (measurement data)
options.machine_name = 'ClearPET2604';
...
if ispc % Windows
    ...
    options.fpath = '/home/rbagaric/Downloads/GATE/output/ClearPET3';
end
